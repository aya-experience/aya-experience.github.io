              ...
              <div className={Styles.logoContainer}>
                ...
                <div className="row">
                  <a href="https://twitter.com/AyaExperience" className={Styles['logo-twitter_container']} target="_blank">
                    <i className={Styles['icon-twitter']} aria-hidden="true"></i>
                  </a>
                  <a href="https://medium.com/aya-experience" className={Styles['logo-medium_container']} target="_blank">
                ...
                <a href="https://fr.linkedin.com/company/zenika" target="_blank">
                  <i className={Styles['icon-linkedin']} aria-hidden="true"></i>
                </a>
              </div>
            </div>
          </div>
